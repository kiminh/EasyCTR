...
def _check_nkfm_args(args):
    check_arg(args, 'nkfm_use_shared_embedding', bool)
    check_arg(args, 'nkfm_use_project', bool)
    check_arg(args, 'nkfm_project_size', int)
    check_arg(args, 'nkfm_hidden_units', list)
    check_arg(args, 'nkfm_activation_fn', str)
    check_arg(args, 'nkfm_dropout', float)
    check_arg(args, 'nkfm_batch_norm', bool)
    check_arg(args, 'nkfm_layer_norm', bool)
    check_arg(args, 'nkfm_use_resnet', bool)
    check_arg(args, 'nkfm_use_densenet', bool)
...
def get_nkfm_logits(
    ...
    with tf.variable_scope('nkfm'):
        _check_nkfm_args(extra_options)
        use_shared_embedding = extra_options['nkfm_use_shared_embedding']
        use_project = extra_options['nkfm_use_project']
        project_size = extra_options['nkfm_project_size']
        hidden_units = extra_options['nkfm_hidden_units']
        activation_fn = extra_options['nkfm_activation_fn']
        dropout = extra_options['nkfm_dropout']
        batch_norm = extra_options['nkfm_batch_norm']
        layer_norm = extra_options['nkfm_layer_norm']
        use_resnet = extra_options['nkfm_use_resnet']
        use_densenet = extra_options['nkfm_use_densenet']
        ...
        y = _nkfm(feature_vectors=feature_vectors,
                  units=units,
